...
typedef struct {
  collection_iterator_instance_t rbegin, rend, begin, end;
  collection_iterator_operator_t rnext, rprev, next, prev;
  collection_iterator_dereference_t key, value;
} collection_iterator_traits_t;


typedef struct collection_cyclic_iterator {
  collection_container_t container;
...
extern collection_cyclic_iterator_t collection_cyclic_iterator(collection_t, collection_container_t);
